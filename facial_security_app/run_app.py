...
from facial_security_app import EmbeddingsManager
...
if __name__ == '__main__':
    ...
    while True:
        ...
        for loc, emb in zip(faces_locations, embeddings):
            ...
            cv2.putText(frame, name + " " + str(round(distance,2)), (loc[3], loc[2] + 40), cv2.FONT_HERSHEY_SIMPLEX, 1, color, 2, cv2.LINE_AA)
